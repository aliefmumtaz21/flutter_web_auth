...
class FlutterWebAuth {
  ...
  static Future<String> authenticate({required String url, required String callbackUrlScheme, bool? preferEphemeral, bool? forceOpenInBrowser}) async {
    ...
    return await _channel.invokeMethod('authenticate', <String, dynamic>{
      ...
      'forceOpenInBrowser': forceOpenInBrowser ?? false,
    }) as String;
  }
